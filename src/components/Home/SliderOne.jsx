...
import Background from '../../assets/img/slider_bg.png'
import Backgroundtwo from '../../assets/img/slider_bg_01.png'

function SampleNextArrow(props) {
    const { className, style, onClick } = props;
    return (
        <button type="button" className={ `slick-next ${className}`} style={{ ...style }} onClick={onClick} ><i className="fa fa-angle-right"></i></button>
    );
}
...
function SamplePrevArrow(props) {
    const { className, style, onClick } = props;
    return (
        <button type="button" className={ `slick-prev ${className}`} style={{ ...style }} onClick={onClick} ><i className="fa fa-angle-left"></i></button>
    );
}
                        ...
                        <div className="col-lg-7 col-md-7">
                            ...
                            <div className="slider-btn mt-30">
                                <Link to="/about" className="btn ss-btn mr-15" data-animation="fadeInLeft" data-delay=".4s" >
                                    Discover More <i className="fal fa-solid fa-arrow-right" />
                                </Link>
                                <Link to="/contact" className="btn ss-btn active" data-animation="fadeInLeft" data-delay=".4s" >
                                    Contact Us <i className="fal fa-solid fa-arrow-right" />
                                </Link>
                            </div>
                            </div>
                        </div>
            ...
            <div className="container">
                ...
                <div className="col-lg-4 col-md-12 col-sm-12">
                    ...
                    <div className="sr-contner">
                        ...
                        <Link to="/about">
                            Read More <i className="fal fa-solid fa-arrow-right" />
                        </Link>
                        </div>
                    </div>
                    </div>
