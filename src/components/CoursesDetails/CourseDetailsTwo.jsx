...
const courseContent = [
    {
        id: 'headingThree',
        title: 'Coures Content',
        duration: '5 leactures . 80 min',
        lectures: [
            {
                title: 'Robotics',
                duration: 'Duration: 0Hrs 20Mins',
            },
            {
                title: 'Computer science',
                duration: 'Duration: 2Hrs 20Mins',
            },
            {
                title: 'Donec pulvinar magna',
                duration: 'Duration: 45Mins',
            },
            {
                title: 'Donec laoreet vestibulum',
                duration: 'Duration: 0Hrs 20Mins',
            },
        ],
    },
    ...
    {
        id: 'headingTwo',
        title: 'Type, Color & Icon Introductions',
        duration: '5 leactures . 70 min',
        lectures: [
            {
                title: 'Robotics',
                duration: 'Duration: 0Hrs 20Mins',
                                                                ...
                                                                <ul>
                                                                    {content.lectures.map((lecture, i) => (
                                                                        <li key={i}>
                                                                            <a href="#">
                                                                                <div className="text">
                                                                                    <i className="fa fa-edit" /> {lecture.title}
                                                                                </div>
                                                                                <div className="time">
                                                                                    <i className="fa fa-clock" /> {lecture.duration}
                                                                                </div>
                                                                            </a>
                                                                        </li>
                                                                    ))}
                                ...
                                <aside className="sidebar-widget info-column">
                                    <div className="inner-column3">
                                        ...
                                        <ul className="project-info clearfix">
                                            ...
                                            <li>
                                                <span className="icon fa fa-home-lg-alt" />{" "}
                                                <strong>Instructor:</strong> <span>Eleanor Fant</span>
                                            </li>
                                            <li>
                                                <span className="icon fa fa-book" />{" "}
                                            ...
                                            <li>
                                                <div className="slider-btn">
                                                    <Link to="/contact" className="btn ss-btn smoth-scroll">
                                                        Enroll <i className="fa fa-long-arrow-right" />
                                                    </Link>
                                                </div>
                                            </li>
                                        </ul>
