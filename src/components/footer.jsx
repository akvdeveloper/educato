              ...
              <div className="footer-widget mb-30">
                ...
                <div className="recent-blog-footer">
                  <ul>
                    <li>
                      <div className="thum">
                        <img src="assets/img/blog/s-blogimg-01.png" alt="Latest Blog Post 1" />
                      </div>
                      <div className="text">
                        <Link to="/blog-details">Nothing impossible to need hard work</Link>
                        <span>7 March, 2020</span>
                      </div>
                    </li>
                    <li>
                      <div className="thum">
                        <img src="assets/img/blog/s-blogimg-02.png" alt="Latest Blog Post 2" />
                      </div>
                      <div className="text">
                        <Link to="/blog-details">Nothing impossible to need hard work</Link>
                        <span>7 March, 2020</span>
            ...
            <div className="col-xl-3 col-lg-3 col-sm-6">
              <div className="footer-widget mb-30">
                ...
                <div className="f-contact">
                  <ul>
                    <li>
                      <i className="icon fal fa fa-phone" />
                      <span>
                        <Link to="tel:+14440008888">+1 (444) 000-8888</Link><br />
                        <Link to="tel:+917052101786">+91 7052 101 786</Link>
                      </span>
                    </li>
                    <li>
                      <i className="icon fal fa-solid fa-envelope" />
                      <span>
                    ...
                    <li>
                      <i className="icon fal fa fa-map-marker" />
                      <span>
                        1247/Plot No. 39, 15th Phase,<br /> LHB Colony, Kanpur
                      </span>
                    </li>
                  </ul>
                </div>
